...
#define CS_SETOUT() TRISBbits.TRISB10 = 0; 
#define CS_LOW()  LATBbits.LATB10 = 0;	/* MMC CS = L */
#define CS_HIGH() LATBbits.LATB10 = 1;	/* MMC CS = H */
#define	FCLK_SLOW()	SPI1CON1bits.PPRE = 1;		/* Set slow clock (312kHz) */
#define	FCLK_FAST()	SPI1CON1bits.PPRE = 3;      /* Set fast clock (8MHz) */
